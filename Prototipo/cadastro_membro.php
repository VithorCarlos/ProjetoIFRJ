        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="cadastro_membro.php" method="POST">
                ...
                <div class="wrap-input100 validate-input" data-validate="Campo Obrigatório">
                    ...
                    <input id="cpf_membro" class="input100" type="text" name="cpf_membro" maxlength="11" onkeyup="somenteNumeros(this)" placeholder="Digite seu CPF...">
                    <span class="focus-input100"></span>
                </div>
                ...
                <div class="wrap-input100 validate-input" data-validate="Email válido requirido: ex@abc.xyz">
                    ...
                    <input id="telefone_membro" class="input100" type="text" name="telefone_membro" maxlength="12" onkeyup="somenteNumeros(this)" placeholder="Digite seu telefone...">
                    <span class="focus-input100"></span>
                </div>
